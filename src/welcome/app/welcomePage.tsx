        ...
        >
          ...
          <Grid item xs={6}>
            <StartPanel
              ...
              connectedServers={props.connectedServers}
            />
          </Grid>
          <Grid item xs={6}>
            <SettingsPanel
